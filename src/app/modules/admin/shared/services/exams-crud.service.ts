...
export class ExamsCrudService {
  ...
  scheduleExam(exam: Exam): Observable<ExamReturnResponse> {
    return this.http.post<ExamReturnResponse>(candidateExamServerUrl + '/AddCandidateExam', exam)
  }
  ...
  getScheduleList(): Observable<ScheduleResponse> {
    return this.http.get<ScheduleResponse>(candidateExamServerUrl + '/ScheduleList?pageIndex=1&pageSize=100');
  }

  rescheduleCandidateUserExam(exam: RescheduleCandidateExamUser): Observable<RescheduleCandidateExamUserResponse> {
    return this.http.post<RescheduleCandidateExamUserResponse>(candidateExamServerUrl + '/RescheduleCandidateUserExam', exam);
  }

  rescheduleCandidateExam(exam: RescheduleCandidateExam):Observable<ExamReturnResponse> {
    return this.http.post<ExamReturnResponse>(candidateExamServerUrl + '/RescheduleCandidateExam', exam);
  }
}
